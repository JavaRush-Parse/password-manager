...
class RedirectConstantsTest {
  ...
  void testRedirectHomeConstant() {
    assertEquals(
        "redirect:/", RedirectConstants.REDIRECT_HOME, "REDIRECT_HOME should point to root path");
  }
  ...
  void testRedirectCollectionsConstant() {
    assertEquals(
        ...
        RedirectConstants.REDIRECT_COLLECTIONS,
  ...
  void testConstantsAreNotNull() {
    ...
    assertNotNull(
        RedirectConstants.REDIRECT_COLLECTIONS, "REDIRECT_COLLECTIONS should not be null");
  }

  @Test
  void testConstantsStartWithRedirect() {
    assertTrue(
        RedirectConstants.REDIRECT_HOME.startsWith("redirect:"),
        "REDIRECT_HOME should start with 'redirect:'");
    assertTrue(
        RedirectConstants.REDIRECT_COLLECTIONS.startsWith("redirect:"),
  ...
  void testClassIsFinal() {
    assertTrue(
        Modifier.isFinal(RedirectConstants.class.getModifiers()),
  ...
  void testConstantsAreFinal() throws NoSuchFieldException {
    assertTrue(
        Modifier.isFinal(RedirectConstants.class.getField("REDIRECT_HOME").getModifiers()),
        "REDIRECT_HOME should be final");
    assertTrue(
        Modifier.isFinal(RedirectConstants.class.getField("REDIRECT_COLLECTIONS").getModifiers()),
  ...
  void testConstantsAreStatic() throws NoSuchFieldException {
    assertTrue(
        Modifier.isStatic(RedirectConstants.class.getField("REDIRECT_HOME").getModifiers()),
        "REDIRECT_HOME should be static");
    assertTrue(
        Modifier.isStatic(RedirectConstants.class.getField("REDIRECT_COLLECTIONS").getModifiers()),
  ...
  void testConstantsArePublic() throws NoSuchFieldException {
    assertTrue(
        Modifier.isPublic(RedirectConstants.class.getField("REDIRECT_HOME").getModifiers()),
        "REDIRECT_HOME should be public");
    assertTrue(
        Modifier.isPublic(RedirectConstants.class.getField("REDIRECT_COLLECTIONS").getModifiers()),
